...
For stability, we recommend pinning the version of the action. See [Releases](https://github.com/step-security/release-on-push-action/releases).
...
export GITHUB_REPOSITORY=step-security/release-on-push-action
